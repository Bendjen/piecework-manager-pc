<template>
  <div class='comparisonContainer' >
    ...
    <v-chart :forceFit="true" :height="height" :data="chartData" :scale="scale">
      ...
      />
      <v-axis data-key="出货" :grid="axisGrid" :label="axisLabel"/>
      <v-bar position="type*计单" color="#3182bd"/>

      <v-smooth-line position="type*出货" color="#fdae6b" :size="gemoSize"/>
      <v-point shape="circle" position="type*出货" color="#fdae6b" :size="gemoSize"/>
    </v-chart>
  </div>
</template>
